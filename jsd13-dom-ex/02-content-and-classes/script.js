...
document.getElementById("card").getAttribute("class")
...
document.getElementById("card").dataset.visits = Number(document.getElementById("card").dataset.visits) + 1;
console.log(document.getElementById("card").dataset.visits)
